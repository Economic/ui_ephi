---
title: "X.X million workers likely lost their employer-provided health insurance in the past 8 weeks"
...
### Table 1: New UI claims and employer-provided health insurance losses between March 15 and May 9, by industry
```{r us_claims}
datatable(
  ephi_industry,
...
### Table 2. Estimated new UI claims and employer-provided health insurance losses between March 15 and May 9, by state
```{r}
ephi_state %>% 
  datatable(
