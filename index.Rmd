---
title: "X.X million workers likely lost their employer-provided health insurance in the past 4 weeks"
...
### Table 1: New UI claims and EPHI losses for the four weeks ending March 21 through April 11, by industry
```{r us_claims}
datatable(
  ephi_industry,
  rownames = FALSE, 
...
### Table 2. Estimated new UI claims and EPHI losses for the weeks ending March 21 through April 11, by state
```{r}
ephi_state %>% 
  datatable(
    rownames = FALSE, 
