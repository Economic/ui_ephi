---
title: "X.X million workers likely lost their employer-provided health insurance in the past 6 weeks"
...
### Table 1: New UI claims and employer-provided health insurance losses between March 15 and April 25, by industry
```{r us_claims}
datatable(
  ephi_industry,
...
### Table 2. Estimated new UI claims and employer-provided health insurance losses between March 15 and April 25, by state
```{r}
ephi_state %>% 
  datatable(
