...
### Table 1: New UI claims and EPHI losses for the six weeks during March 15 - April 25, by industry
```{r us_claims}
datatable(
  ephi_industry,
...
### Table 2. Estimated new UI claims and EPHI losses for six weeks during March 15 - April 25, by state
```{r}
ephi_state %>% 
  datatable(
